...
/**
 * The schema is used by a Standard Graphic to define the data payload of the 'update' method.
 */
...
export interface Http1270018084JsonSchemaV1GraphicsManifestSchemaJson {
  /**
  ...
  version?: string;
  /**
   * The main entry point, ie the path to the main javascript file of the Graphic. If not set, defaults to 'graphic.mjs'.
   */
  main?: string;
  /**
   * Name of the Graphic
  ...
  /**
   * Indicates if the Graphic supports non-real-time rendering. Note: If true, the Graphic must implement the 'goToTime()' and the 'setInvokeActionsSchedule()' methods.
   */
  supportsNonRealTime?: boolean;
  /**
   * The number of steps in the Graphic. If the Graphic is simply triggered by a play, then a stop, this is considered a stepCount of 1.
   */
  stepCount?: number;
  schema?: HttpsSuperflytvGithubIoGraphicsDataDefinitionGddMetaSchemaV1LibObjectJson1;
  /**
   * This interface was referenced by `Http1270018084JsonSchemaV1GraphicsManifestSchemaJson`'s JSON-Schema definition
   * via the `patternProperty` "^v_.*".
   */
  [k: string]: unknown;
}
