				...
				<div className="intial-hero">
					<div className="intial-hero-content">
						...
						<div>
							...
							<p>
								It reads Graphics from your local hard drive and displays them in this web page <br /> (nothing is sent
								to any servers).
							</p>
							...
							<p>
								...
								<a href="https://github.com/SuperFlyTV/tmp-GraphicsDefinition/tree/master/reference/graphics">here</a>!)
							</p>
							<p>
